...
export const projects: Project[] = [
  ...
  },
  {
    ...
    technologies: ['Go', 'Redis', 'Auth0', 'Cobra', 'Gin'],
  ...
  },
  {
    title: 'Subsbase',
    subtitle: 'API',
    description: 'Concurrent subscription microservice.',
    technologies: ['Go', 'Redis', 'PostgreSQL', 'Mux'],
    repoUrl: 'https://github.com/charmingruby/subsbase',
    demoUrl: '',
  },
  {
    title: 'Backpago',
    ...
    technologies: ['Go', 'AWS', 'RabbitMQ', 'Chi', 'PostgreSQL'],
  ...
  },
  {
    title: 'Jobify',
    subtitle: 'API',
    description: 'Jobs vacancy management.',
